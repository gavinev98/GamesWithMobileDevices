...
public class AppPurchaseManger : Singleton<AppPurchaseManger>, IStoreListener
{
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, GOLD_50, StringComparison.Ordinal))
        {
            ...
            InAppPurchaseDataManager.Instance.AddGold(50);
